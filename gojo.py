...
bot_token = '7092345115:AAFYJDmLuGLRac_Iy_4ig9eikCDfupkCSMI'  # Replace with your bot token
...
ADMIN_ID = 2117490063  # Replace with the actual admin's user ID
...
def run_attack(target, port, attack_time, sent_message):
    try:
        full_command = f".gojo/ {target} {port} {attack_time}"
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @TANISHULTRA54: {ADMIN_ID}")
